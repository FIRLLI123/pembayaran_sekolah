...
class ReportController extends Controller
{
    public function exportExcel(Request $request): JsonResponse
    {
        ...
        $jumlahTransaksiPembayaran = (int) $pembayaranSummaryQuery->count();
        ...
        foreach ($kelases as $kls) {
            ...
            // Count lunas/belum lunas per student in this period
            $siswaLunasCount = 0;
            ...
            foreach ($siswaIds as $sId) {
                ...
                if ($sTagihans->isEmpty()) {
                    continue; // No invoices for this student in this period
                }
            ...
            $rekapKelasData[] = [
                ...
                'tahun_ajaran' => '2025/2026', // Default School Year
        ...
        $headerStyle = [
            ...
            'fill' => [
                ...
                'startColor' => ['rgb' => '1E40AF'], // brand_600/700 Blue
            ],
            'alignment' => [
        ...
        // Clean up old files (older than 1 day) in exports directory
